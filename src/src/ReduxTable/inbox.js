...
import {  remove, selectPeople, selectLoading } from "./inboxSlice";
...
import PeopleInboxDialog from "../Inbox/PeopleInboxDialog";
import Button from "@material-ui/core/Button";
import AddIcon from "@material-ui/icons/Add";
import Tooltip from "@material-ui/core/Tooltip";
import DeleteInboxDialog from "../Inbox/DeleteInboxDialog";
import DeleteIcon from "@material-ui/icons/Delete";
import { SummaryCard } from "../Inbox/Inboxval";
...
export default function Inbox() {
  ...
  const SetFlag = (event,ids,checkbox) => {
    ...
    {
      document.getElementById(ids).style.backgroundColor="rgb(158 200 244)";
    }
    else
    {
      ...
      {
        for(var i=0 ; i<len; i++){
          galleries[i].style.backgroundColor="rgb(158 200 244)";
       }
      }
      else{
